...
CSS = """
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .evid { display:flex; flex-wrap:wrap; gap:0; border-top:1px solid var(--line); background:var(--panel); }
...
{company}
      <div class="evid">
        <div class="cell"><div class="k">Register evidence</div><div class="v">{src_cell}</div></div>
        <div class="cell"><div class="k">First recorded</div><div class="v">{e(pretty_date(r["source_date"]))}</div></div>
        <div class="cell"><div class="k">Status</div><div class="v">{e(r["status"].title())}</div></div>
        <div class="cell"><div class="k">Method</div><div class="v"><a href="/research/digital-product-passport/suppliers#method">How we verify &#8599;</a></div></div>
      </div>
    </div>
